...
+ (NSString *)birthdayChangeToAge:(NSString *) birthdayStr {
    ...
    if (birthday) {
        NSInteger bYear = [self getDateComponent:FCMYear date:birthday];
        NSInteger bMonth = [self getDateComponent:FCMMonth date:birthday];
        NSInteger bDay = [self getDateComponent:FCMDay date:birthday];
        
        NSDate *nowday = [NSDate date];
        NSInteger nYear = [self getDateComponent:FCMYear date:nowday];
        NSInteger nMonth = [self getDateComponent:FCMMonth date:nowday];
        NSInteger nDay = [self getDateComponent:FCMDay date:nowday];
...
+ (NSInteger)getDateComponent:(FCMDateComponent)dateComponent date:(NSDate *)date {
...
+ (NSString *)getWeekWithString:(NSString *)dateString{
    ...
    NSInteger weekNo = [self getDateComponent:FCMWeekDay date:date];
    switch (weekNo) {
        case 1:

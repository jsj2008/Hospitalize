...
- (void)viewDidLoad{
    ...
    self.view.backgroundColor = COLOREFF3F6;
    ...
    UIView *searchView = [[UIView alloc] initWithFrame:CGRectMake(0, 5, self.view.frame.size.width, 40*(self.view.frame.size.height/568))];

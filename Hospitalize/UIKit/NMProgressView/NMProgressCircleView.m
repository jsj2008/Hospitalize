...
@implementation NMProgressCircleView
{
    float progress;
}
...
+(NMProgressCircleView*)circleWithColor:(UIColor*)color width:(CGFloat)width
{
    ...
    NMProgressCircleView *circle = [[NMProgressCircleView alloc] initWithFrame:CGRectMake(0, 0, width, width)];
    circle.color = color;
    return circle;
}

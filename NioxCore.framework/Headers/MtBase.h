...
@interface NMTFPage : NSObject <TBase, NSCoding> {
  int32_t __pageNo;
  int32_t __pageSize;
  int64_t __total;
...
@interface NMTFDevice : NSObject <TBase, NSCoding> {
  NSString * __deviceId;
...
@interface NMTFReqHeader : NSObject <TBase, NSCoding> {
  int32_t __appType;
...
@property (nonatomic, retain, getter=device, setter=setDevice:) NMTFDevice * device;
...
- (id) init;
- (id) initWithAppType: (int32_t) appType appVersion: (NSString *) appVersion token: (NSString *) token timestamp: (int64_t) timestamp nonce: (NSString *) nonce signature: (NSString *) signature userId: (int64_t) userId device: (NMTFDevice *) device appKind: (int32_t) appKind appMark: (NSString *) appMark;
...
#if !__has_feature(objc_arc)
- (NMTFDevice *) device;
- (void) setDevice: (NMTFDevice *) device;
#endif
- (BOOL) deviceIsSet;
...
@interface NMTFRespHeader : NSObject <TBase, NSCoding> {
  int32_t __status;
  NSString * __msg;
...
@interface NMTFMtBaseConstants : NSObject {
}
@end
